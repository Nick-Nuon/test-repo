...
make clean
# # === Setup log file ===
LOGFILE="base64_benchmark_gcc_$(date +'%Y-%m-%d_%H-%M-%S').log"
...
# # === Setup log file ===
LOGFILE="base64_benchmark_clang_$(date +'%Y-%m-%d_%H-%M-%S').log"
exec > >(tee -a "$LOGFILE") 2>&1
...
# # === Build standalone benchmark binary ===
# echo "🧪 Compiling base64_encoding_benchmark.c with GCC..."
gcc -O3 -mavx2 -I./include ./util/base64_encoding_benchmark.c ./crypto/evp/encode.c -o ./util/perf_basic -lcrypto
