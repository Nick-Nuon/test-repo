...
int EVP_DecodeFinal_test(EVP_ENCODE_CTX *dummy,
...
const case_pair no_padding[] = {
    ...
    const case_pair invalid_cases[] = {
        ...
        {"x...", "eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eA====\n"},
        
        // Data after padding in multiline
        {"x...", "eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eA==\neHh4eHh4eHh4eHh4eHh4eHh4\n"},
        {"x...", "eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4\neA==eHh4eHh4eHh4eHh4eHh4\n"},

        {"hello", "\x61\x47\x56\x73\x62\x47\x38"},
        {"hello", "\x61\x47\x56\x73\x62\x47\x38\x0a"},
        {"hello", "\x61\x47\x56\x73\x62\x47\x38\x3d\x3d\x0a"},
        {"T3BlblNTT", "\x54\x33\x42\x6c\x62\x6c\x4e\x54\x54\x45\x39\x77\x5a\x57\x35\x54\x55\x30\x77"},
        {"T3BlblSS", "\x54\x33\x42\x6c\x62\x6c\x4e\x54\x54\x45\x39\x77\x5a\x57\x35\x54\x55\x30"},
        {"T3BlblR", "\x54\x33\x42\x6c\x62\x6c\x4e\x54\x54\x45\x39\x77\x5a\x57\x35\x54\x55"},
        {"A", "\x41"},
        {"A", "\x41\x0a"},
        {"A", "\x41\x3d"},
        {"A", "\x41\x3d\x3d\x0a"},
        
        {"auto", ""},    };


    static int test_encode_base64_invalid_cases(void) {
        // int result = check_cases(invalid_cases, sizeof(invalid_cases)/sizeof(invalid_cases[0]));
        ...
        for(size_t i = 0; i < sizeof(invalid_cases)/sizeof(invalid_cases[0]); i++) {
            ...
            ASSERT_EQUAL_INT(outlen_openssl, outlen_simdutf);
...
// this is true in the original, the original tests the ignore_garbage option
    ...
    static int test_base64_decode_just_one_padding_loose(void) {
        ...
        for (size_t i = 0; i < num_cases; i++) {
            ...
            ASSERT_MEM_EQUAL(back_ssl, back_simd, out_ssl);
...
static int test_streaming_base64_roundtrip(void)
{
    ...
    for (window = 16; window <= 2048; window += 7) {
        DEBUG_PRINT("Testing window size: %zu\n", window);

        /* Allocate back buffers for decoded binary data */
        unsigned char *back_simd = OPENSSL_malloc(len + 2);
        unsigned char *back_openssl = OPENSSL_malloc(len + 2);
        if (!back_simd || !back_openssl) {
            TEST_error("Out of memory for back buffers");
            OPENSSL_free(source);
            OPENSSL_free(buffer);
        ...
        for (pos = 0; pos < size; pos += window) {
            ...
            int result_openssl = OpenSSL_decode(NULL,
                                              (char *)back_openssl, 
                                              &outlen_openssl,
                                              buffer + pos,
                                              count);
            ...
            ASSERT_EQUAL_INT(result_simd, result_openssl);
            ASSERT_EQUAL_INT(outlen_simd, outlen_openssl);
...
static int test_random_padding_and_spaces(void) {
    size_t len, i;
    unsigned int seed = 12345;  /* Fixed seed for reproducibility */
    DEBUG_PRINT(GREEN_TEXT("DEBUG: Entered test_random_padding_and_spaces\n"));
    ...
    for (len = 1; len < 512; len++) {
        ...
        /* Add lots of random spaces (20-50) */
        size_t num_spaces = 20 + (rand_r(&seed) % 31);
        for (i = 0; i < num_spaces; i++) {
            size_t pos = add_space(&buffer, &actual_len, &seed);
            if (pos == (size_t)-1) {
                TEST_error("Failed to add space");
                OPENSSL_free(buffer);
                return 0;
            }
        }

        DEBUG_PRINT("Created string with padding at pos %zu and %zu spaces: %s\n", 
                   pad_pos, num_spaces, buffer);
